...
Let's say the secret word is "HANGMAN". Then the following expression should mask the secret word as 
...
You can find the code sample in [this](https://github.com/meenakshi-dhanani/react-hangman) repo. Feel free to write to us at meena24dhanani@gmail.com for any feedback. You can also submit PRs that extend the game. 
